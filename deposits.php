...
$depositData1 = generateDepositData();
$depositData2 = generateDepositData();
?>
<!DOCTYPE html>
...
<body>
    <div class="container">
        <header>
            ...
            <p class="subtitle">Решите задачи по расчёту банковских вкладов</p>
        </header>

        <main>
            <div class="widgets-container">
                <?php include 'deposit-widget.php'; ?>
            </div>
        </main>

        <footer>
            <p>&copy; <?= date('Y') ?> Банковские вклады</p>
        </footer>
    </div>
