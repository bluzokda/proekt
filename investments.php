...
$investmentData = generateInvestmentData();
?>
<!DOCTYPE html>
...
<body>
    <div class="container">
        <header>
            ...
            <p class="subtitle">Проанализируйте данные по инвестициям и вычислите итоговую стоимость портфеля</p>
        </header>

        <main>
            <div class="widgets-container">
                <?php include 'investment-widget.php'; ?>
            </div>
        </main>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            function disableWidget(widget, correctAnswer) {
                ...
                if (highlightCell) {
                    ...
                    const formattedAnswer = parseInt(correctAnswer).toLocaleString('ru-RU');
                    highlightCell.textContent = `${formattedAnswer} ₽`;
                    ...
                    highlightCell.innerHTML = `${formattedAnswer} ₽ <span style="color:var(--success);margin-left:8px;">✓</span>`;
                }
